        ...
        while True:
            try:
                if self.verbose:
                    ...
                    print(
                        f"[{self.COLOR_CYAN}2{self.COLOR_RESET}] Toggle Tor Proxy (Enable/Disable)")
                    print(
                        f"[{self.COLOR_CYAN}3{self.COLOR_RESET}] View Tor IP History")
                    print(f"[{self.COLOR_CYAN}4{self.COLOR_RESET}] Exit")
